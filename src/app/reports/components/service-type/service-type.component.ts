...
export class ServiceTypeComponent implements OnInit {
  ...
  init(): void {
    ...
    this.serviceTypesList = Object.keys(ServiceTypes).filter((k) => isNaN(Number(k)));
  ...
  getSessionsReport(params: NzTableQueryParams): void {
    ...
    this.reportService.getSessionsReport(params, this.searchParams, 'service_type').subscribe((data) => {
